...
export default class extends Controller {
  ...
  normalize() {
    this.firstNamesTarget.value = this.normalizeIdentity(this.firstNamesTarget.value, false);
    this.lastNameTarget.value = this.normalizeIdentity(this.lastNameTarget.value, true);
  }
